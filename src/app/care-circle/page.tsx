...
const counsellors = [
  {
    ...
    description: "Hello dear, I’m Dr. Ananya. Life can be overwhelming, but you're not alone. Let's walk through your thoughts gently, and I’ll help you find a peace, clarity, and self-compassion.",
  ...
  },
  {
    ...
    imageUrl: 'https://placehold.co/400x300/E0E7FF/3730A3.png?text=RB',
  ...
  },
  {
    ...
    imageUrl: 'https://placehold.co/400x300/F43F5E/FEE2E2.png?text=Z',
  ...
  },
  {
    ...
    imageUrl: 'https://placehold.co/400x300/2563EB/DBEAFE.png?text=V',
  ...
  },
  {
    ...
    imageUrl: 'https://placehold.co/400x300/14B8A6/CCFBF1.png?text=TM',
